#' Title for the function (Adaptive-Rejection Sampling)
#'
#' Description - The objective of this package is to create a function that
...
ars <- function(n, 
  ...
  while (count <= n) {
    ...
    x_star <- r(distr::AbscontDistribution(d=calc_nom_s_j(piece_selected), 
