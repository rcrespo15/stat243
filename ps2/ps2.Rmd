...
write.table(b, file = '/tmp/tmp.csv', quote=FALSE, row.names=FALSE, col.names = FALSE, sep=',')
save(b, file = '/tmp/tmp.Rda', compress = FALSE)
...
```
Part d
The matrix format requires a larger space. 
